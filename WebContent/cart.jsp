	...
	<body>
		...
		<div class="container">
				...
				<div style="margin:0 auto; margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<!-- map中键是pid，值是cartItems -->
							<c:forEach items="${cart.cartItems }" var="entry">
							<!-- 这里取的是map集合，不是list集合，注意区分  -->
							<tr class="active">
								...
								<td width="10%">
									<%-- <input type="text" name="quantity" value="${entry.value.buyNums }" maxlength="4" size="10"> --%>
									${entry.value.buyNums }
								</td>
								<td width="15%">
								...
								<td>
																											<!-- 注意此处要单引号 -->
									<a href="javascript:void(0);" class="delete" onclick="deleteProduct('${entry.value.product.pid }')">删除</a>
								</td>
							</tr>
							</c:forEach>
						</tbody>
			...
			<div style="margin-right:130px;">
				...
				登录后确认是否享有优惠&nbsp;&nbsp;
				</em> 赠送积分: <em style="color:#ff6600;">0</em>&nbsp; 商品金额: <strong style="color:#ff6600;">￥:0元</strong>
				</c:if>
				...
				登录后确认是否享有优惠&nbsp;&nbsp;
					...
					<em style="color:#ff6600;">${cart.total }</em>&nbsp; 商品金额: <strong style="color:#ff6600;">￥:${cart.total }元</strong>
				</c:if>
			
				</div>
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					<a href="javacript:void(0);" onclick="clearCart()" id="clear" class="clear">清空购物车</a>
					<a href="${pageContext.request.contextPath }/submitOrder">
						<!-- 提交订单的时候，如果没有用户登录不能提交 -->
