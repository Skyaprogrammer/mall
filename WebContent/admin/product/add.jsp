...
<HTML>
		...
		<script type="text/javascript">
			...
			$(function(){
				$.post(
					//1.必须
					//2.url，地址
					"${pageContext.request.contextPath }/findAllCategory",
					function(data){
						//json就是一个一个的空括号里面是键值对  每一个空括号就是一个category
						//拼接content直接传入
						var content = "";
	...
	<body>
		<!-- 注意多功能表单提交的话，会使得request的getParamter失效 -->
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="pname" value="" id="pname" name="pname" class="bg"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						是否热门：
					</td>
