...
<script type="text/javascript">
			...
			function deleteCategory(cid){
				...
				if(isDel){
					window.location.href="${pageContext.request.contextPath}/deleteCategoryServlet?cid="+cid;
				}else{
					return false;
				}
			}
					...
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<tr onmouseover="this.style.backgroundColor = 'white'"
							...
							<td align="center" style="HEIGHT: 22px">
								<a href="${ pageContext.request.contextPath }/editCategory?cid=${category.cid }">
									<img src="${pageContext.request.contextPath}/images/i_edit.gif" border="0" style="CURSOR: hand">
								</a>
							</td>

							<td align="center" style="HEIGHT: 22px">
								<a href="javascript:;" onclick="deleteCategory('${category.cid}')">
