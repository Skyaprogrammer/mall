...
<script type="text/javascript">
	//在js中可以获取到input中用户输入的数量
	function addCart(){
		/* var buyNumEle = document.getElementById("#quantity");
		var buyNum = buyNumEle.value; */
	...
	<div class="container">
		<div class="row">
			<div
				...
				<!-- 这里牵扯到了多表查询，所以暂时先不处理 -->
				<a href="default.jsp">首页&nbsp;&nbsp;&gt;</a> <a href="#">蔬菜&nbsp;&nbsp;&gt;</a>
				<a>${product.pname }</a>
			</div>
